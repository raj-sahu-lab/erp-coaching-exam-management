...
Imports System.Math
Partial Class admin_fee_collect
    ...
    Protected Sub Search_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Search.Click
        ...
        If dr.Read() Then
            ...
            Else
                ...
                Page.ClientScript.RegisterStartupScript(Type.GetType("System.String"), "ALERT", "alert('Data was not found');menubar=yes;window.location.href = 'followup.aspx';", True)
                dr.Close()
                dd_pay_type.ClearSelection()
                cmd.Parameters.Clear()
        ...
        Else
            ...
            Page.ClientScript.RegisterStartupScript(Type.GetType("System.String"), "ALERT", "alert('Student not found. Start New enquiry');menubar=yes;", True)
        End If
    End Sub
    ...
    Protected Sub make_payment_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles make_payment.Click
        ...
        If dd_pay_type.SelectedItem.Text = "Token + Part Payment" Then
            Response.Redirect("admin_fee_collect_token_pay.aspx")
        ElseIf dd_pay_type.SelectedItem.Text = "No Token + Part Payment" Then
            Response.Redirect("admin_fee_collect_notoken_pay.aspx")
        ElseIf dd_pay_type.SelectedItem.Text = "Token + Lumpsum Payment" Then
            Response.Redirect("admin_fee_collect_token_lumpsum.aspx")
        ElseIf dd_pay_type.SelectedItem.Text = "No Token + Lumpsum Payment" Then
            Response.Redirect("admin_fee_collect_notoken_lumpsum.aspx")
        End If
        student_name.Text = ""
        rb_female.Checked = False
        rb_male.Checked = False
