<%@ Page Title="" Language="VB" MasterPageFile="~/pt-website.master" AutoEventWireup="false" CodeFile="exam_reg.aspx.vb" Inherits="exam_create" %>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="style1">
                                ...
                                <asp:DropDownList ID="dd_exam_date" runat="server" 
                                        DataSourceID="test_date" DataTextField="ExamDate" DataValueField="Examid" 
                                    Height="22px" Width="148px">
                                    </asp:DropDownList>
                        <asp:SqlDataSource ID="test_date" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:pt_enquiry %>" 
                            
                            
                                    
                                    SelectCommand="SELECT [Examid], convert(varchar,[ExamDate],111) as ExamDate FROM [ExamMaster] ORDER BY [ExamDate]">
                        </asp:SqlDataSource>
                            ...
                            <td>
                             ...
                             <td>
                                 ...
                                 <asp:RegularExpressionValidator ID="RegularExpressionValidator_attempts" 
                                     runat="server" ControlToValidate="attempts" ErrorMessage="Enter valid No" 
                            ...
                            <td>
                             ...
                             <td>
                                 ...
                                 <asp:RegularExpressionValidator ID="RegularExpressionValidator_correct" 
                                     runat="server" ControlToValidate="correct" ErrorMessage="Enter Valid No" 
                                     ValidationExpression="^[0-9]{1,4}$"></asp:RegularExpressionValidator>
                                 <br />
                            ...
                            <td>
                             ...
                             <td>
                                 ...
                                 <asp:RegularExpressionValidator ID="RegularExpressionValidator_wrong" 
                                     runat="server" ControlToValidate="wrong" ErrorMessage="Enter Valid No" 
                                     ValidationExpression="^[0-9]{1,4}$"></asp:RegularExpressionValidator>
                                 <br />
