<%@ Page Title="" Language="VB" MasterPageFile="~/pt-website.master" AutoEventWireup="false" CodeFile="followup.aspx.vb" Inherits="followup" %>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                ...
                                <asp:TextBox ID="mobile" runat="server" Width="178px"></asp:TextBox>
                         ...
                         <tr>
                            ...
                            <td class="style1">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator_d4" 
                                    runat="server" ControlToValidate="date_f4" ErrorMessage="Enter Valid Date" 
                                    ValidationExpression="(19|20|21)\d\d[\/](0[1-9]|1[012])[\/](0[1-9]|[12][0-9]|3[01])" 
                                    Width="108px"></asp:RegularExpressionValidator>
