<%@ Page Title="" Language="VB" MasterPageFile="~/pt-website.master" AutoEventWireup="false" CodeFile="admin_master_set.aspx.vb" Inherits="admin_master_set" %>
                ...
                <a href="home.aspx"><img src="images/logo.png" title="[Company Name]" alt="Logo PT" border="0" /></a>--%>
                   ...
                   <div id="bodyPanel">
	                    <div id="master"  style="margin-left:130px; margin-top:100px">
                            <asp:Panel ID="Panel1" runat="server" Height="568px">
                            <table>
                            <tr>
