<%@ Page Title="" Language="VB" MasterPageFile="~/pt-website.master" AutoEventWireup="false" CodeFile="session_exp.aspx.vb" Inherits="session_exp" %>
	                ...
	                <table style="margin: 50px 0 0 40px; width: 258px; height: 140px;">
	                    <tr align="center">
	                        <td colspan="2">
                                ...
                                <br />
                                Enquiry System your session expired</td>
	                    </tr>
	                    <tr>
	                        <td align="center" >
                    ...
                    <div id="footerPanel">
                        <div id="footerbodyPanel">
                          <ul>
                            ...
                            <p class="copyright">©[Company Name] all right reserved</p>
