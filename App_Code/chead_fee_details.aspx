<%@ Page Title="" Language="VB" MasterPageFile="~/pt-website.master" AutoEventWireup="false"
    CodeFile="chead_fee_details.aspx.vb" Inherits="chead_fee_details" %>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#3F2B91" Height="59px">
            <table>
                <tr>
                    ...
                    <td align="center" style="margin-left: 40px">
                        &nbsp;&nbsp&nbsp;&nbsp<asp:Button ID="defaulter" runat="server" Text="Update" />
                    </td>
                </tr>
                <tr>
                    <td>
            ...
            <cc1:CoolGridView ID="CoolGridView2" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TotalFee" HeaderText="Fee Paid" SortExpression="TotalFee" />
                    ...
                    <asp:TemplateField HeaderText="Defaulters">
                        <ItemTemplate>
