...
Partial Class admin_master_set
    ...
    Protected Sub add_degree_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles add_degree.Click
        ...
        Page.ClientScript.RegisterStartupScript(Type.GetType("System.String"), "ALERT", "alert('Degree Inserted');menubar=yes;", True)
        degree_name.Text = ""
    End Sub
    ...
    Protected Sub add_branch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles add_branch.Click
        ...
        Page.ClientScript.RegisterStartupScript(Type.GetType("System.String"), "ALERT", "alert('Branch Inserted In Database');menubar=yes;", True)
        branch_name.Text = ""
    End Sub
    Protected Sub dd_course_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles dd_course.SelectedIndexChanged
        course_name.Text = dd_course.SelectedItem.Text
    End Sub
