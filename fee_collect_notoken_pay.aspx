<%@ Page Title="" Language="VB" MasterPageFile="~/pt-website.master" AutoEventWireup="false" CodeFile="fee_collect_notoken_pay.aspx.vb" Inherits="fee_collect_notoken_pay" %>
                ...
                <a href="home.aspx"><img src="images/logo.png" title="[Company Name]" alt="Logo PT" border="0" /></a>--%>
                   ...
                   <div id="bodyPanel">
                    ...
                    <table>
                        ...
                        <tr>
                            <td align="center" colspan="3">
                                <asp:Button ID="pay" runat="server" Text="Pay" Width="103px" />
                            </td>
                        </tr>
