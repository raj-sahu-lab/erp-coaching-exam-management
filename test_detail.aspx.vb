...
Partial Class test_detail
    ...
    Protected Sub search_grid_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles search_grid.Click
        ...
        End If
        Try
            Dim sSQL As String = "SELECT [Mobile], [StudentName], [ExamDate], [Gender], [Degree], [College], [Yearsem], [branch], [CourseTarget], [Waiver], [EnquiryCreated] From [ScholarshipReg] WHERE ([ExamDate] = @enq84)"
            SqlDataSource_students_test.SelectParameters.Add("enq84", dbType:=Data.DbType.Date, value:=dd_selection_date.SelectedItem.Text)
            SqlDataSource_students_test.SelectParameters("enq84").DefaultValue = dd_selection_date.SelectedItem.Text
