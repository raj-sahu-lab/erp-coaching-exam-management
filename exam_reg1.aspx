<%@ Page Title="" Language="VB" MasterPageFile="~/pt-website.master" AutoEventWireup="false" CodeFile="exam_reg1.aspx.vb" Inherits="exam_reg" %>
                ...
                <div id="exam_reg"; style="margin-left:130px">
                    <table>
                        ...
                        <asp:SqlDataSource ID="test_date" runat="server" 
                            ...
                            SelectCommand="SELECT [ExamDate] FROM [ExamMaster]">
                        </asp:SqlDataSource>
