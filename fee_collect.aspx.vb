...
Partial Class fee_collect
    ...
    Protected Sub Search_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Search.Click
        ...
        Else
            ...
            Page.ClientScript.RegisterStartupScript(Type.GetType("System.String"), "ALERT", "alert('Student not found. Start a new enquiry ');menubar=yes;", True)
        End If
    End Sub
