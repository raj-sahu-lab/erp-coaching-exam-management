<%@ Page Title="" Language="VB" MasterPageFile="~/pt-website.master" AutoEventWireup="false" CodeFile="Enquiry_list.aspx.vb" Inherits="Enquiry_list" %>
                ...
                <a href="home.aspx"><img src="images/logo.png" title="[Company Name]" alt="Logo PT" border="0" /></a>--%>
                   ...
                   <div id="bodyPanel">                                 
                        ...
                        <asp:Panel ID="Panel1" runat="server" Height="737px">
                            <cc1:CoolGridView ID="CoolGridView1" runat="server" AllowSorting="True" 
                                AutoGenerateColumns="False" BackColor="White" BorderColor="White" 
                                BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" 
                                DataKeyNames="mobile" DataSourceID="SqlDataSource_enquiry" 
                                Height="737px" Width="760px">
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="enq" HeaderText="Enquiry Date" DataFormatString="{0:yyyy/MM/dd}" SortExpression="enq" />
                                    ...
                                    <asp:BoundField DataField="status_enq" HeaderText="Status" 
                                        SortExpression="status_enq" />
                                    <asp:BoundField DataField="councellor_name" HeaderText="Enq Councellor" 
                                        SortExpression="councellor_name" />   	
                                    ...
                                    <asp:BoundField DataField="councellor_f4" HeaderText="Counsellor 4" 
                                        SortExpression="councellor_f4" />
                                    ...
                                    <asp:BoundField DataField="councellor_f5" HeaderText="Counsellor 5" 
                                        SortExpression="councellor_f5" />                           
                                    ...
                                    <asp:BoundField DataField="councellor_f6" HeaderText="Counsellor 6" 
                                        SortExpression="councellor_f6" />
                                </Columns>
                                <BoundaryStyle BorderColor="Gray" BorderStyle="Solid" BorderWidth="1px" />
                                <RowStyle BackColor="#DEDFDE" ForeColor="Black" />
                            </cc1:CoolGridView>
                            <asp:SqlDataSource ID="SqlDataSource_enquiry" runat="server" 
